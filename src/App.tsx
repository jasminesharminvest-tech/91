...
import { useAutoCleanupSignals } from '@/hooks/useAutoCleanupSignals';
...
export default function App() {
  ...
  // Реальные проблемы, п.6: автоудаление истории сигналов раз в сутки —
  // см. подробное объяснение архитектуры в JSDoc хука. Работает независимо
  // от phase (health/onboarding/terminal), поэтому вызывается на верхнем
  // уровне компонента, а не внутри условных return ниже.
  useAutoCleanupSignals();
